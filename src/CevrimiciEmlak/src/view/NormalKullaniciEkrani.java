...
public class NormalKullaniciEkrani {
	...
	public NormalKullaniciEkrani(UsersModel UserSessionData){
		...
		JMenuItem mntmTest3 = new JMenuItem("Şifre Güncelleme");
		JMenuItem mntmTest4 = new JMenuItem("Mail Güncelleme");
		JMenuItem mntmTest5 = new JMenuItem("Lisans İşlemleri");
		
		menuHesabim.add(mntmTest3);
		menuHesabim.add(mntmTest4);
	...
	public void EmlakIslemleriConstructor(){
		...
		JPanel panel1 = EmlakIlanlari();
		emlakIslemleri.addTab("Emlak İlanları", null, panel1, null);
		JPanel panel2 = FavoriEmlaklarim();
		emlakIslemleri.addTab("Favori Emlaklarım", null, panel2, null);
	...
	public void SifreGuncelleme() {
		...
		usernameIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/password.png")));
		...
		leftHomeIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/synchronize.png")));
	...
	public void EmailGuncelleme(){
		...
		usernameIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/username.png")));
		...
		leftHomeIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/sync.png")));
		leftHomeIcon.setBounds(12, 49, 256, 256);
		mainPanel.add(leftHomeIcon);
	...
	public void EmlakFiltreleme(){
		...
		minPriceIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/price_icon.png")));
		...
		maxPriceIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/price_icon.png")));
		...
		typeIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		provinceIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/map.png")));
		...
		districtIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/map.png")));
		...
		JLabel leftHomeIcon = new JLabel();
		leftHomeIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/filter.png")));
		leftHomeIcon.setBounds(22, 116, 256, 256);
		mainPanel.add(leftHomeIcon);
		
		JLabel backgroundImage = new JLabel();
		backgroundImage.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/bg_middle.png")));
	...
	public void EmlakGoruntuleme(String estateHeader,String estateDesc, String estateType, String estatePrice, String bathCount, String netArea, String grossArea, String roomCount, String floorCount, String heathingType, String Province, String District, String Neighborhood){
		...
		headerFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		descriptionFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		typeComboboxIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		priceFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/price_icon.png")));
		...
		bathFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		netAreaFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		grossAreaFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		roomCountFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		floorFieldIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		heathingComboboxIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		neighborhoodIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/map.png")));
		...
		JLabel leftHomeIcon = new JLabel();
		leftHomeIcon.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/apartment.png")));
		leftHomeIcon.setBounds(12, 194, 256, 256);
		mainPanel.add(leftHomeIcon);
		
		JLabel backgroundImage = new JLabel();
		backgroundImage.setIcon(new ImageIcon(NormalKullaniciEkrani.class.getResource("/assets/images/bg_max.png")));
