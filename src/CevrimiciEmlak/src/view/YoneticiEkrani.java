...
public class YoneticiEkrani {
	...
	public JTabbedPane altYoneticiIslemleri;
	...
	public YoneticiEkrani(UsersModel UserSessionData){
		...
		JMenuItem mntmTest3 = new JMenuItem("Alt Yönetici İşlemleri");
		JMenuItem mntmTest4 = new JMenuItem("Lisans işlemleri");
		
		mnIlemler.add(mntmTest1);
		mnIlemler.add(mntmTest2);
		mnIlemler.add(mntmTest3);
		mnIlemler.add(mntmTest4);
		...
		mntmTest3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HideAll();
				altYoneticiIslemleri.setVisible(true);
			}
		});
		mntmTest4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HideAll();
	...
	public void HideAll() {
		...
		altYoneticiIslemleri.setVisible(false);
	...
	public void refreshAltYoneticiIslemleri() {
		int altYoneticiTabsIndex = altYoneticiIslemleri.getSelectedIndex();
		AltYoneticiIslemleriConstructor();
		altYoneticiIslemleri.setSelectedIndex(altYoneticiTabsIndex);
	}
	...
	public void AltYoneticiIslemleriConstructor(){
		if(altYoneticiIslemleri != null) {
			altYoneticiIslemleri.removeAll(); 
		}else {
			altYoneticiIslemleri = new JTabbedPane(JTabbedPane.TOP);
			altYoneticiIslemleri.setBounds(0, 0, 900, 555);
		}
		
		JPanel subAdmins = AltYoneticiler();
		altYoneticiIslemleri.addTab("Alt Yöneticiler", null, subAdmins, null);
		
		JScrollPane altYoneticiEkleme = AltYoneticiEkleme();
		altYoneticiIslemleri.addTab("Yeni Alt Yönetici Ekleme", null, altYoneticiEkleme, null);
	}
	...
	public JPanel YetkiliKullanicilar() {
		...
		ResultSet Users = UserModel.getUsersByRole(3);
		try {
			while(Users.next()){
	...
	public JPanel NormalKullanicilar() {
		...
		model.setColumnIdentifiers(columnNames);
		ResultSet Users = UserModel.getUsersByRole(4);
		try {
			while(Users.next()){
				Object[] UserData = {Users.getString("Username"), Users.getString("Name"), Users.getString("Surname"), Users.getString("Email"), Users.getString("Phone"), Users.getString("VerifyStatusText"), new ComboDBItem(Users.getInt("UserID"),"Düzenle")};
			    model.addRow(UserData);
	...
	public JPanel OnaysizKullanicilar() {
		...
		model.setColumnIdentifiers(columnNames);
		ResultSet Users = UserModel.getUsersByStatus(0,4); // 0 verifystatus, 4 roleid
		try {
			while(Users.next()) {
	...
	public void KullaniciDuzenleme(int UserID, String Username, String Password, String Name, String Surname, String Phone, String Email, int ProvinceID, int DistrictID, int NeighborhoodID, int VerifyStatus) {
		...
		passwordIcon_1.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/password.png")));
		...
		emailIcon_1.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/confirmation.png")));
		...
		provinceIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/map.png")));
		...
		neighborhoodIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/map.png")));
		neighborhoodIcon.setBounds(286, 471, 35, 35);
		mainPanel.add(neighborhoodIcon);
		
		JLabel districtIcon = new JLabel("New label");
		districtIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/map.png")));
		...
		emailIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/email.png")));
		emailIcon.setBounds(286, 332, 35, 35);
		mainPanel.add(emailIcon);
		
		JLabel telephoneIcon = new JLabel("New label");
		telephoneIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/phone.png")));
		...
		surnameIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/username.png")));
		...
		nameIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/username.png")));
		nameIcon.setBounds(286, 197, 35, 35);
		mainPanel.add(nameIcon);
		
		JLabel usernameIcon = new JLabel("New label");
		usernameIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/username.png")));
		usernameIcon.setBounds(286, 65, 35, 35);
		mainPanel.add(usernameIcon);
		
		JLabel passwordIcon = new JLabel("New label");
		passwordIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/password.png")));
		...
		leftHomeIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/edituser.png")));
		leftHomeIcon.setBounds(12, 169, 256, 256);
		mainPanel.add(leftHomeIcon);
		
		JLabel backgroundImage = new JLabel();
		backgroundImage.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/bg_middle.png")));
		...
		registerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int checkboxStatus;
				if(userStatusCheckBox.isSelected()) checkboxStatus = 1; 
	...
	public void altYoneticiDuzenleme(int UserID, String Username, String Password, String Name, String Surname, String Phone, String Email, int ProvinceID, int DistrictID, int NeighborhoodID) {
		MainFrame editUserFrame = new MainFrame(600, 600);
		JPanel mainPanel = new JPanel();
		JLabel headerLabel = new JLabel("Alt Yönetici Düzenleme");
		headerLabel.setHorizontalAlignment(SwingConstants.LEFT);
		headerLabel.setForeground(Color.WHITE);
		headerLabel.setFont(new Font("Dialog", Font.BOLD, 24));
		headerLabel.setBounds(145, 12, 310, 29);
		...
		JComboBox<ComboDBItem> provincesCombobox = new JComboBox<ComboDBItem>();
		provincesCombobox.setBounds(333, 384, 220, 24);
		provincesCombobox.addItem(new ComboDBItem(-1,"Hizmet Verilecek İl"));
		ResultSet Provinces = LocationModel.getProvinces();
		try {
			while(Provinces.next()) {
				ComboDBItem provinceItem = new ComboDBItem(Provinces.getInt("ProvinceID") ,Provinces.getString("ProvinceName"));
		...
		JComboBox<ComboDBItem> districtsCombobox = new JComboBox<ComboDBItem>();
		districtsCombobox.setBounds(333, 430, 220, 24);
		districtsCombobox.addItem(new ComboDBItem(-1,"Hizmet Verilecek İlçe"));
		if(ProvinceID != -1) {
			ResultSet Districts = LocationModel.getDistricts(ProvinceID);
			try {
				while(Districts.next()) {
		...
		JComboBox<ComboDBItem> neighborsCombobox = new JComboBox<ComboDBItem>();
		neighborsCombobox.setBounds(333, 476, 220, 24);
		neighborsCombobox.addItem(new ComboDBItem(-1,"Hizmet Verilecek mahalle/belde/köy"));
		if(DistrictID != -1) {
			ResultSet Neighborhoods = LocationModel.getNeighborhoods(DistrictID);
			try {
				while(Neighborhoods.next()) {
		...
		registerButton.setBorder(new LineBorder(Color.decode("#FFFFFF"),1));
		registerButton.setBackground(new Color(0, 0, 51));
		registerButton.setBounds(286, 526, 123, 25);
		mainPanel.add(registerButton);
		...
		cancelButton.setBorder(new LineBorder(Color.decode("#FFFFFF"),1));
		cancelButton.setBackground(new Color(0, 0, 51));
		cancelButton.setBounds(430, 526, 123, 25);
		mainPanel.add(cancelButton);
		...
		registerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				UsersController UserController = new UsersController();
				try {
					UserController.editSubAdmin(UserID, nameField.getText(),surnameField.getText(),new String(passwordField.getPassword()),new String(repasswordField.getPassword()), telephoneField.getText(), emailField.getText(),provinceSelected.ElementID,districtsSelected.ElementID,neighborhoodSelected.ElementID);
					JOptionPane.showMessageDialog(mainFrame, "Kullanıcı başarıyla düzenlendi.");
					refreshAltYoneticiIslemleri();
				} catch (Exception e) {
	...
	public void LisansDuzenleme(int LicenseID,String License, String Date){
		...
		Icon1.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/date.png")));
		Icon1.setBounds(153, 148, 35, 35);
		editLicensePanel.add(Icon1);
		
		Icon2.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/key.png")));
		...
		saveButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					refreshLisansIslemleri();
					editLicenseFrame.setVisible(false);
					editLicenseFrame.dispose();
				} catch (Exception e) {
					JOptionPane.showMessageDialog(mainFrame,e.getMessage());
				}
			}
	...
	public JPanel TumLisanslar() {
		...
		model.setColumnIdentifiers(columnNames);
		ResultSet ActiveLicenses = LicensesModel.getAllActiveLicenses();
		ResultSet InactiveLicenses = LicensesModel.getInactiveLicenses();
	...
	public JScrollPane AltYoneticiEkleme() {
		JPanel lisansEkleme= new JPanel();
		
		JScrollPane lisansEklemeScrollPane = new JScrollPane();
		lisansEklemeScrollPane.setBounds(0,0,895, 528);
		
		lisansEkleme.setPreferredSize(new Dimension(850,630));
		lisansEkleme.setLayout(null);
		lisansEkleme.setBounds(0, 0, 850, 528);
		
		JLabel usernameFieldLabel = new JLabel("Kullanıcı Adı");
		usernameFieldLabel.setForeground(Color.BLACK);
		usernameFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		usernameFieldLabel.setBounds(325, 30, 325, 15);
		lisansEkleme.add(usernameFieldLabel);

		JTextField usernameField = new JTextField();
		usernameField.setBounds(325, 50, 325, 25);
		lisansEkleme.add(usernameField);

		JLabel passwordFieldLabel = new JLabel("Şifre");
		passwordFieldLabel.setForeground(Color.BLACK);
		passwordFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		passwordFieldLabel.setBounds(325, 90, 325, 15);
		lisansEkleme.add(passwordFieldLabel);	
		
		JTextField passwordField = new JTextField();
		passwordField.setBounds(325, 110, 325, 25);
		lisansEkleme.add(passwordField);

		JLabel nameFieldLabel = new JLabel("Adı");
		nameFieldLabel.setForeground(Color.BLACK);
		nameFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		nameFieldLabel.setBounds(325, 150, 325, 15);
		lisansEkleme.add(nameFieldLabel);	
		
		JTextField nameField = new JTextField();
		nameField.setBounds(325, 170, 325, 25);
		lisansEkleme.add(nameField);

		
		JLabel surnameFieldLabel = new JLabel("Soyadı");
		surnameFieldLabel.setForeground(Color.BLACK);
		surnameFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		surnameFieldLabel.setBounds(325, 210, 325, 15);
		lisansEkleme.add(surnameFieldLabel);	
		
		JTextField surnameField = new JTextField();
		surnameField.setBounds(325, 230, 325, 25);
		lisansEkleme.add(surnameField);

		
		JLabel phoneFieldLabel = new JLabel("Telefon");
		phoneFieldLabel.setForeground(Color.BLACK);
		phoneFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		phoneFieldLabel.setBounds(325, 270, 325, 15);
		lisansEkleme.add(phoneFieldLabel);	
		
		JTextField telephoneField = new JTextField();
		telephoneField.setBounds(325, 290, 325, 25);
		lisansEkleme.add(telephoneField);

		JLabel emailFieldLabel = new JLabel("Email");
		emailFieldLabel.setForeground(Color.BLACK);
		emailFieldLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		emailFieldLabel.setBounds(325, 330, 325, 15);
		lisansEkleme.add(emailFieldLabel);	
		
		JTextField emailField = new JTextField();
		emailField.setBounds(325, 350, 325, 25);
		lisansEkleme.add(emailField);
		
		JLabel provincesComboboxLabel = new JLabel("Hizmet Verilecek İl");
		provincesComboboxLabel.setForeground(Color.BLACK);
		provincesComboboxLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		provincesComboboxLabel.setBounds(325, 390, 325, 15);
		lisansEkleme.add(provincesComboboxLabel);	
		
		JLabel districtsComboboxLabel = new JLabel("Hizmet Verilecek İlçe (Opsiyonel)");
		districtsComboboxLabel.setForeground(Color.BLACK);
		districtsComboboxLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		districtsComboboxLabel.setBounds(325, 450, 325, 15);
		lisansEkleme.add(districtsComboboxLabel);	
		
		JLabel neighborsComboboxLabel = new JLabel("Hizmet Verilecek mahalle/belde/köy (Opsiyonel)");
		neighborsComboboxLabel.setForeground(Color.BLACK);
		neighborsComboboxLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
		neighborsComboboxLabel.setBounds(325, 510, 325, 15);
		lisansEkleme.add(neighborsComboboxLabel);
		
		JComboBox<ComboDBItem> provincesCombobox = new JComboBox<ComboDBItem>();
		JComboBox<ComboDBItem> districtsCombobox = new JComboBox<ComboDBItem>();
		JComboBox<ComboDBItem> neighborsCombobox = new JComboBox<ComboDBItem>();
		
		lisansEkleme.add(provincesCombobox);	
		lisansEkleme.add(districtsCombobox);	
		lisansEkleme.add(neighborsCombobox);
		...
		provincesCombobox.setBounds(325, 410, 325, 25);
		districtsCombobox.setBounds(325, 470, 325, 25);
		neighborsCombobox.setBounds(325, 530, 325, 25);
		...
		btnNewButton_1.setBounds(325, 575, 150, 25);
		lisansEkleme.add(btnNewButton_1);
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					UsersController.CreateSubAdmin(2,1,usernameField.getText(),passwordField.getText(),passwordField.getText(), telephoneField.getText(), emailField.getText(), nameField.getText(), surnameField.getText(), provincesSelected.ElementID, districtsSelected.ElementID, neighborsSelected.ElementID);
		...
		btnNewButton.setBounds(500, 575, 150, 25);
		lisansEkleme.add(btnNewButton);

		lisansEklemeScrollPane.setViewportView(lisansEkleme);
		return lisansEklemeScrollPane;
	}
	public JPanel AltYoneticiler() {
		JPanel altYoneticiler= new JPanel();
		int buttonColumnID = 5;
		JScrollPane altYoneticilerScrollPane = new JScrollPane();
		DefaultTableModel model = new DefaultTableModel() {
			@Override
			public boolean isCellEditable(int row, int column) {
				return column == buttonColumnID;
		...
		JTable altYoneticilerTable = new JTable( model );
		String[] columnNames = {"Kullanıcı Adı", "İsim", "Soyisim","Mail","Telefon", "Düzenle"};
		altYoneticiler.add(altYoneticilerScrollPane);
		altYoneticiler.setLayout(null);
		altYoneticiler.setBounds(0, 0, 900, 555);
		altYoneticilerScrollPane.setBounds(0, 0, 895, 528);
		
		model.setColumnIdentifiers(columnNames);
		ResultSet subAdmins = UserModel.getUsersByRole(2); // 2 = subadmin
		try {
			while(subAdmins.next()){
				Object[] subAdminData = {subAdmins.getString("Username"), subAdmins.getString("Name"), subAdmins.getString("Surname"), subAdmins.getString("Email"), subAdmins.getString("Phone"),new ComboDBItem(subAdmins.getInt("UserID"),"Düzenle")};
			    model.addRow(subAdminData);
			}
		} catch (SQLException e) {
			e.printStackTrace();
		}
		Action altYoneticilerButtonAction = new AbstractAction()
		{
		    public void actionPerformed(ActionEvent e)
		    {
		        JTable altYoneticilerTable = (JTable)e.getSource();
		        int modelRow = Integer.valueOf( e.getActionCommand() );
		        ComboDBItem ElementID = (ComboDBItem) ((DefaultTableModel)altYoneticilerTable.getModel()).getValueAt(modelRow, buttonColumnID);
		        ResultSet selectedSubAdminData = UserModel.getUserByID(ElementID.ElementID);
		        try {
		        	if(selectedSubAdminData.next()){
		        		altYoneticiDuzenleme(selectedSubAdminData.getInt("UserID"),selectedSubAdminData.getString("Username"), selectedSubAdminData.getString("Password") , selectedSubAdminData.getString("Name"), selectedSubAdminData.getString("Surname"), selectedSubAdminData.getString("Phone"), selectedSubAdminData.getString("Email"), selectedSubAdminData.getInt("ProvinceID"), selectedSubAdminData.getInt("DistrictID"), selectedSubAdminData.getInt("NeighborhoodID"));		        		
		        	}
				} catch (SQLException e1) {
		...
		altYoneticilerTable.setAutoCreateRowSorter(true);
		ButtonColumn buttonColumn = new ButtonColumn(altYoneticilerTable, altYoneticilerButtonAction, buttonColumnID);
		buttonColumn.setMnemonic(KeyEvent.VK_D);

		altYoneticilerScrollPane.setViewportView(altYoneticilerTable);
		return altYoneticiler;
	}
	...
	public JPanel onaysizEmlaklar() {
		...
		model.setColumnIdentifiers(columnNames);
		ResultSet Estates = EstateModel.getEstatesByVerifyStatus(0);
		try {
			while(Estates.next()){
	...
	public void EmlakDuzenleme(String estateHeader,String estateDesc, int estateType, String estatePrice, String bathCount, String netArea, String grossArea, String roomCount, String floorCount, int heathingType, int provinceID, int districtID, int neighborhoodID, int VerifyStatus, int EstateID) {
		...
		headerFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		descriptionFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		typeComboboxIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		priceFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/price_icon.png")));
		...
		bathFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		netAreaFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		grossAreaFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		roomCountFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		floorFieldIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		heathingComboboxIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/estate_icon.png")));
		...
		JLabel leftHomeIcon = new JLabel();
		leftHomeIcon.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/apartment.png")));
		leftHomeIcon.setBounds(12, 194, 256, 256);
		mainPanel.add(leftHomeIcon);
		
		JLabel backgroundImage = new JLabel();
		backgroundImage.setIcon(new ImageIcon(YoneticiEkrani.class.getResource("/assets/images/bg_max.png")));
